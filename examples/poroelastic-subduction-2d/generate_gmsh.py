...
class App(GenerateMesh):
    ...
    def __init__(self):
        ...
        self.filename = "outer_rise_poro-2D.msh"
    ...
    def create_geometry(self):
        ...
        # Create Outer Rise Fault
        self.p_fault_edge = gmsh.model.geo.add_point(175600, -30000, 0.0)
        self.c_outerrise_fault = gmsh.model.geo.add_line(9, self.p_fault_edge)
    ...
    def mark(self):
        ...
        vertex_groups = (
            ...
            VertexGroup(name="outer_rise_fault", tag=23, dim=1, entities=[self.c_outerrise_fault]),
            VertexGroup(name="outer_rise_fault_edge", tag=33, dim=0, entities=[self.p_fault_edge]),
        )
    ...
    def generate_mesh(self, cell):
        ...
        gmsh.model.mesh.field.setNumbers(fault_distance, "CurvesList", [self.c_slabtop_mantle_upper, self.c_slabtop_crust, self.c_outerrise_fault])
